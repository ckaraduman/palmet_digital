...
<html>
	<head>
    <h1>Palmet Dijital Yönetim Uygulaması</h1>
    <h2>Evrak Takip Sistemi</h2>
    
    <div id="menu">
        <a href="admin.php">Ana Menü</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <a href="evrak_index.php">Belge Yönetimi Ana Menü</a>&nbsp;&nbsp;&nbsp;&nbsp;
        <br><br>
    </div>
    <form name="evrak" method="POST" action="evrak_index.php">
    <table>
    <tr><td>Belge Tarihi</td>
    <td><input type="date" name="kontrol_tarihi"></td></tr>
    <tr><td>Kayıt Numarası</td>
    <td><input type=text name="belge_no" style="width:137px"></td></tr>
    <tr><td>Gönderen Kurum/Kişi&nbsp;&nbsp;&nbsp;&nbsp;</td>
    <td><select class="other1" name="musteri">
    <option value="seçim yapılmadı" selected>Gönderen Kurumu Seçiniz</option>
    <?php
    $sql = "select * from kit";
    ...
    <tr><td>Konu</td>
    <td><input type=text name="konu" size="100"></td></tr>
    </table>
    <br>
    <form method="post"><input type="submit" name="premac2" id="premac2" value="Kaydet"></form></td>
    <br><br>
