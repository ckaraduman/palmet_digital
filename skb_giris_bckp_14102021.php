...
<?php
              ...
              $tsql = "SELECT [Name],[NoktaKodu],[RemoteTime],[Consumption],[GunlukButceSkb],[GunlukGerceklesmeSkb]  FROM [TMX].[dbo].[Botas_EBT_Integration_cem] where NoktaKodu='".$nokta_kodu."' and RemoteTime>='".$tarih1."' and RemoteTime<='".$tarih2."'";
              ...
              foreach($results as $row){
                ...
                $sonuc = $row['NoktaKodu'].'&nbsp;&nbsp;&nbsp;&nbsp;'.$row['RemoteTime'].'&nbsp;&nbsp;&nbsp;&nbsp;'.number_format(($row['Consumption']), 2, ',', '.');
                echo "<br>";
                print $sonuc;
              }
              }
...
?>
    <table border="1">
        <tr>
          ...
          <?php
          $msql = "select NoktaKodu from Points";
