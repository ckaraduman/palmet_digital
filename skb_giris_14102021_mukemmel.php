...
<?php
              ...
              $tsql = "SELECT [Name],[NoktaKodu],[RemoteTime],[Consumption],[GunlukButceSkb],[GunlukGerceklesmeSkb]  FROM [TMX].[dbo].[Botas_EBT_Integration_cem] where NoktaKodu='".$nokta_kodu."' and RemoteTime between '".$tarih1."' and '".$tarih2."' order by RemoteTime";
              ...
              $tsql = "SELECT [Name],[NoktaKodu],[RemoteTime],[Consumption],[GunlukButceSkb],[GunlukGerceklesmeSkb]  FROM [TMX].[dbo].[Botas_EBT_Integration_cem] where NoktaKodu='".$nokta_kodu."' and RemoteTime between '".$tarih1."' and '".$tarih2."'";
              //$tsql = "select * from Botas_EBT_Integration where RemoteTime='".$tarih1." 08:00:00.000'";
              $getResults = $connect->prepare($tsql);
              $getResults->execute();
              $results = $getResults->fetchAll(PDO::FETCH_BOTH);
