...
try {
    ...
    $mail->Host       = 'smtp.office365.com';					// Email sunucu adresi. Genellikle mail.domainadi.com olarak kullanilir. Bu adresi hizmet saglayiciniza sorabilirsiniz
    $mail->SMTPAuth   = true;									// SMTP kullanici dogrulama kullan
    $mail->Username   = 'pcms@palmet.com';				// SMTP sunucuda tanimli email adresi
    $mail->Password   = 'Rb89X5CV';							// SMTP email sifresi
    ...
    $mail->setFrom('pcms@palmet.com', 'Palmet'); // Gonderen bilgileri yukaridaki $mail->Username ile aynı deger olmali

    //Alici Ayarları
    $mail->addAddress('c.karaduman@palmet.com', 'Cem İlker Karaduman'); // Alıcı bilgileri
    $mail->addAddress('cemilkerkaraduman@gmail.com');					// İkinci alıcı bilgileri
